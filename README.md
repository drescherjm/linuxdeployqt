...
This fork is mainly interested in using linuxdeployqt for deployment of vcpkg packages. 

**Below this line contains the original text from the original repository unmodified.**
